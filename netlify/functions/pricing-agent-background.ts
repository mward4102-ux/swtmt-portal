// Netlify Background Function — pricing agent
...
import { runPricingAgent } from '../../src/lib/agents/pricing-agent';
...
const handler: Handler = async (event) => {
  ...
  try {
    ...
    console.error('[pricing-agent-background] failed:', err.message);
